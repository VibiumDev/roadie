...
- **Multiple targets**: run one instance per target on a single host, each pinned to its own capture dongle and relay board, with a `/wall` page to view and drive them together
